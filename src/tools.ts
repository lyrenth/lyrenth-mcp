 ...
 *
 *   idempotentHint  true:  repeat calls with the same arguments cause no
 *                          additional effect on the environment, which is
 *                          the hint's meaning per the MCP spec. It is not
 *                          a promise of byte-identical output (a page can
 *                          change between reads); output stability is not
 *                          what the hint describes. 0.1.5 left this unset
